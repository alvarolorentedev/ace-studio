...
class AceStudio:
    ...
    def settings_dialog(self) -> ft.AlertDialog:
        ...
        content = ft.ListView([
            ...
            self.card(ft.Text("About", size=20, weight=ft.FontWeight.W_600), ft.Text("ACE Studio 0.1.8"), ft.Text("ACE-Step is installed from its official upstream repository and keeps its own license files.", color=MUTED)),
